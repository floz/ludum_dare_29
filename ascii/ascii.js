    ...
    function asciifyImage(oImg, oCanvasImg) {
        ...
        for (var y = 0; y < iHeight; y += 2) {
            for (var x = 0; x < iWidth; x++) {
                ...
                if (strThisChar == " " || strThisChar == undefined) strThisChar = " ";

                if (bColor) {
                    strChars += "<span style='" + "color:rgba(" + iRed + "," + iGreen + "," + iBlue + "," + iAlpha + ");" + (bBlock ? "background-color:rgb(" + iRed + "," + iGreen + "," + iBlue + ");" : "") + (bAlpha ? "opacity:" + (iAlpha / 255) + ";" : "") + "'>" + strThisChar + "</span>";
                } else {
